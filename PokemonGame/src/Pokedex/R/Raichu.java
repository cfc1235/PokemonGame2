...
import Moveset.Electric.ThunderPunch;
...
public class Raichu extends Pokemon {
    ...
    public void Initialize(int level){
        ...
        Collections.addAll(this.TMmoves, addMegaPunch(), addMegaKick(), addPayDay(),
                ...
                addFling(), addSpeedSwap(), addRound(), addVoltSwitch(), addElectroweb(),
                addDrainingKiss(), addElectricTerrain(), addEerieImpulse(), addBrutalSwing(),
                addBodySlam(), addSurf(), addThunderbolt(), addThunder(), addAgility(),
                addSubstitute(), addReversal(), addEndure(), addSleepTalk(), addEncore(),
                addIronTail(), addUproar(), addFocusBlast(), addNastyPlot(), addGrassKnot(),
                addElectroBall(), addWildCharge(), addPlayRough(), addFocusPunch(), addDoubleTeam(),
                addShockWave(), addChargeBeam(), addFlash(), addSwagger(), addStrength(),
                addRockSmash());
        Collections.addAll(this.learnedMoves, new CreateOrderedMap<>(0, addThunderShock()),
                ...
                new CreateOrderedMap<>(0, addThunderWave()), new CreateOrderedMap<>(0, addDoubleTeam()),
                new CreateOrderedMap<>(0, addElectroBall()), new CreateOrderedMap<>(0, addFeint()),
                new CreateOrderedMap<>(0, addSpark()), new CreateOrderedMap<>(0, addAgility()),
                new CreateOrderedMap<>(0, addSlam()), new CreateOrderedMap<>(0, addDischarge()),
                new CreateOrderedMap<>(0, addThunderbolt()), new CreateOrderedMap<>(0, addLightScreen()),
                new CreateOrderedMap<>(0, addThunder()), new CreateOrderedMap<>(0, addThunderPunch()));
    ...
    public Raichu(int level, GlobalVariables globalVariables){
        Initialize(level);
        addFirstMoves();
        setFirstEVs();
        setNature();
        ...
        setFullDirName("Raichu.png", globalVariables);
    }

    public Raichu(int level, List<Moves> oldMoves, String Nature,
        ...
        setFullDirNameEvolution(isShiny, "Raichu.png");
