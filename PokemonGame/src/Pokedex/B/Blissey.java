...
public class Blissey extends Pokemon {
    public void Initialize(int level){
        ...
        Collections.addAll(this.learnedMoves, new CreateOrderedMap<>(0, addSweetKiss()),
                ...
                new CreateOrderedMap<>(0, addMinimize()), new CreateOrderedMap<>(0, addCharm()),
                new CreateOrderedMap<>(4, addTailWhip()), new CreateOrderedMap<>(8, addEchoedVoice()),
                new CreateOrderedMap<>(12, addLifeDew()), new CreateOrderedMap<>(16, addSing()),
                new CreateOrderedMap<>(20, addFling()), new CreateOrderedMap<>(24, addTakeDown()),
                new CreateOrderedMap<>(28, addHealPulse()), new CreateOrderedMap<>(32, addHelpingHand()),
                new CreateOrderedMap<>(36, addLightScreen()), new CreateOrderedMap<>(40, addDoubleEdge()),
                new CreateOrderedMap<>(44, addSoftBoiled()), new CreateOrderedMap<>(48, addLastResort()),
                new CreateOrderedMap<>(52, addHealingWish()));
        setGivesEVs(0, 0, 0, 0, 0, 2);
        setBaseStats(10, 10, 255, 75,
                135, 55, 242, 30,
                103.2, "Normal", "Fast",
                level, 395);
        this.setPokeCry("242Cry.wav");
    ...
    public Blissey(int level, GlobalVariables globalVariables){
        Initialize(level);
        addFirstMoves();
        setFirstEVs();
        setNature();
        ...
        setFullDirName("Blissey.png", globalVariables);
    }

    public Blissey(int level, List<Moves> oldMoves, String Nature,
        ...
        setFullDirNameEvolution(isShiny, "Blissey.png");
