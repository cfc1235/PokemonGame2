...
public class BasculinWhite extends Pokemon {
    public BasculinWhite(int level, GlobalVariables globalVariables){
        this.setFirstEVs();
        this.isHisuian = true;
        ...
        setNextLevelEXP();
        setEXPNeeded();
        this.setFullDirName("BasculinWhite.png", globalVariables);
